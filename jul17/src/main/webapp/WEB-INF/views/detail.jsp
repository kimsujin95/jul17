...
//			const bno = "${dto.bno}";
			...
			recommentBox += '<form action="./cupdate" method="post">';
...
<body>
	...
	<h1>상세보기</h1>
	<!-- 2023-07-18 / 데이터베이스 구현 / 메뉴 만들기, 글쓰기 -->
	<div class="detail-content">
		<div class="title">
			${dto.bno } / ${dto.btitle }
			<c:if
				test="${sessionScope.mid ne null && sessionScope.mid eq dto.m_id }">
				<img alt="" src="./img/update.png" onclick="update()">&nbsp;<img
								...
								<div class="commentHead">
									<div class="cname">
										...
										<c:if test="${sessionScope.mid ne null && sessionScope.mid eq c.m_id }">
											<img alt="" src="./img/update.png" class="cupdate" onclick="cupdate()">&nbsp;
